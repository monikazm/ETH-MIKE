...
REDCAP_EXCLUDED_COLS = {'gender', 'handedness', 'impaired_side', 'details_on_stroke', 'date_mri', 'lesion_location_detailed','ae_date_reporting','ae_reporting_initials','ae_description','ae_date_beginning','ae_date_end','ae_intensity','ae_action_taken','ae_outcome','adverse_events_complete','dd_date','dd_experimenter','dd_nature','dd_impact','dd_description','dd_date_occurance','device_deficiency_complete','study_end_date','study_completed','study_ended_earlier','study_dropout_reasons','end_of_study_report_complete'}
