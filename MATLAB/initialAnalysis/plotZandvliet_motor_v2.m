...
for i=unique(C(:,1))'
    ...
    if C(temp(1),4) < 18
        if sum(i == subjectImprovedSRD) > 0 && sum(i == subjectImprovedMDC) > 0 
            ...
            F.MarkerFaceColor = [0.9290, 0.6940, 0.1250];
...
% print('Plots/LongitudinalPlots/Zandvliet/210125_Indiv_ForceFlex','-dpng')
% ylabel('AROM (deg)') 
% print('Plots/LongitudinalPlots/Zandvliet/210125_Indiv_AROM','-dpng')
ylabel('Max Force Flex (N)') 
%print('Plots/LongitudinalPlots/Zandvliet/210125_Indiv_MaxVelExt','-dpng')
