%% Compare Max Force Flex and FMA at different time points 
% created: 11.08.2021
...
columnNrs = 114; % Max Force Flex
FMA = 41; 

T1 = readtable(filename1); 
A = table2array(T1(:,[3 5 FMA columnNrs]));
...
% xticks([0 1 2 3])
% ylim([0 27])
xlabel('Fugl-Meyer @ inclusion')
ylabel('Max Force Flex @ inclusion') 
title('Force Flex vs FMA @ T1') 
print('Plots/ScatterPlots/210811_ForceFlex_FMA_inclusion','-dpng')
...
% xticks([0 1 2 3])
% ylim([0 27])
xlabel('Fugl-Meyer @ discharge')
ylabel('Max Force Flex @ discharge') 
title('Force Flex vs FMA @ T3') 
print('Plots/ScatterPlots/210811_ForceFlex_FMA_discharge','-dpng')
...
% xticks([0 1 2 3])
% ylim([5 27])
xlabel('Delta by MDC FMA')
ylabel('Delta by SRD Force Flex') 
title('Delta Force Flex by SRD vs delta FMA by MDC') 
print('Plots/ScatterPlots/210811_ForceFlex_FMA_changebySRD','-dpng')
