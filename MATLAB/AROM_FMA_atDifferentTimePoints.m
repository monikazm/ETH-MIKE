...
title('AROM vs FMA @ T1') 
print('Plots/ScatterPlots/210811_AROM_FMA_inclusion','-dpng')
...
title('AROM vs FMA @ T3') 
print('Plots/ScatterPlots/210811_AROM_FMA_discharge','-dpng')
...
title('Delta AROM by SRD vs delta FMA by MDC') 
print('Plots/ScatterPlots/210811_AROM_FMA_changebySRD','-dpng')
