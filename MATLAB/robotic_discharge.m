...
Both(:,5) = Both(:,3)>10.63; 
filename = 'PMimpaired_source_discharge_170521.xlsx';
...
print('Plots/BaselineComparison/robotic/210517_PM_Indiv_discharge','-dpng')
...
xticklabels({'Affected' , 'Less affected'}); 
ylabel('Position Matching Absolute Error (deg)') 
print('Plots/BaselineComparison/robotic/210517_PM_withMean_discharge','-dpng')
