...
A = table2array(T1(:,[3 5 FMSensory columnNrs]));
...
% xticks([0 1 2 3])
ylim([0 27])
xlabel('FM-UL Sensory @ inclusion')
ylabel('Position matching error @ inclusion') 
title('PM vs FMS @ T1') 
print('Plots/ScatterPlots/210817_PM_FMS_inclusion','-dpng')
...
% xticks([0 1 2 3])
ylim([0 27])
xlabel('FMA Sensory @ discharge')
ylabel('Position matching error @ discharge') 
title('PM vs FMS @ T3') 
print('Plots/ScatterPlots/210817_PM_FMS_discharge','-dpng')
...
title('Delta PM by SRD vs delta FMS') 
print('Plots/ScatterPlots/210817_PM_FMS_changebySRD','-dpng')
