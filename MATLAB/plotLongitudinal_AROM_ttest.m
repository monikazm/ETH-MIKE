...
% lognitudinal plotting, Active Range of Motion 
...
print('Plots/LongitudinalPlots/robotic/210819_AROM_3sessions','-dpng')
...
ylim([-5 105]) 
ylabel('Active Range of Motion (deg)') 
print('Plots/LongitudinalPlots/robotic/210819_AROM_InclDisch','-dpng')
...
[p_anov,tbl_anov,stats_anov] = anova1([Sesh(:,2) Sesh(:,3)]);
