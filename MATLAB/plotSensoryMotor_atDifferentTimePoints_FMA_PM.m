...
%ylim([-2 4])
title('FMA vs PM @ T1')
print('Plots/ScatterPlots/210817_FMA_PM_T1','-dpng')
...
%ylim([-2 4])
title('FMA vs PM @ T3')
print('Plots/ScatterPlots/210817_FMA_PM_T3','-dpng')
...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta FMA vs PM')
print('Plots/ScatterPlots/210817_FMA_PM_delta','-dpng')
...
% xlim([-1.2 0.8])
ylim([-5 27])
title('Delta FMA vs PM @ T1')
print('Plots/ScatterPlots/210817_FMA_delta_PMT1','-dpng')
...
xlim([0 26])
ylim([-5 27])
title('Delta FMA vs PM @ T1 - IMPROVING')
print('Plots/ScatterPlots/210817_FMA_delta_PMT1_IMPROVING','-dpng')
...
xlim([0 26])
ylim([-5 27])
title('Delta FMA vs PM @ T1 - NON-IMPROVING')
print('Plots/ScatterPlots/210817_FMA_delta_PMT1_NONIMPROVING','-dpng')
...
%% Box plot improving vs not improving (PM @ T1) 
anovadata = [Sesh1_2(:,4); Sesh1_3(:,4)];
for i=1:length(Sesh1_2(:,1))
    gr1(i,1) = {'Improving FMA'}; 
end
for i=1:length(Sesh1_3(:,1))
    gr2(i,1) = {'Non-improving FMA'}; 
end
anovagroups = [gr1(:,1);gr2(:,1)]; 

[~,~,stats_anova_kw] = kruskalwallis(anovadata,anovagroups); 
[c,~,~,gnames] = multcompare(stats_anova_kw,'CType','bonferroni'); 
