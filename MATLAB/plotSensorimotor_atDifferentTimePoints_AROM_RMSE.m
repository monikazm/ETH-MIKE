...
% xlim([-1.2 0.8])
%ylim([0 1.1])
title('AROM vs RMSE @ T1')
print('Plots/ScatterPlots/210811_RMSEvsAROM_T1','-dpng')
...
% xlim([-1.2 0.8])
%ylim([0 1.1])
title('AROM vs RMSE @ T3')
print('Plots/ScatterPlots/210811_RMSEvsAROM_T3','-dpng')
...
%ylim([0 1.1])
title('AROM vs MAPR')
print('Plots/ScatterPlots/210811_RMSEvsAROM_T1T3','-dpng')
...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta AROM vs RMSE')
print('Plots/ScatterPlots/210811_RMSEvsAROM_delta','-dpng')
