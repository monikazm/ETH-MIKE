%% Compare Max Force Flex and FMA Hand at different time points 
% created: 11.08.2021
...
title('Force Flex vs FMAH @ T1') 
print('Plots/ScatterPlots/210811_ForceFlex_FMAH_inclusion','-dpng')
...
title('Force Flex vs FMAH @ T3') 
print('Plots/ScatterPlots/210811_ForceFlex_FMAH_discharge','-dpng')
...
title('Delta Force Flex by SRD vs delta FMAH') 
print('Plots/ScatterPlots/210811_ForceFlex_FMAH_changebySRD','-dpng')
