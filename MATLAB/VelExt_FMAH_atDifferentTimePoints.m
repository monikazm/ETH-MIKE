%% Compare Max Velocity Extension and FMA Hand at different time points 
% created: 11.08.2021
...
title('Vel Ext vs FMAH @ T1') 
print('Plots/ScatterPlots/210811_VelExt_FMAH_inclusion','-dpng')
...
title('Vel Ext vs FMAH @ T3') 
print('Plots/ScatterPlots/210811_VelExt_FMAH_discharge','-dpng')
...
title('Delta Vel Ext by SRD vs delta FMAH') 
print('Plots/ScatterPlots/210811_VelExt_FMAH_changebySRD','-dpng')
