%% identify factors that contribute to change %% 

% start with sensory score PM 
% created: 24.08.2021
...
A = table2array(T(:,[3 5 92 114 160 127 122 46 47 61])); 
...
meanDSS = [mean(S1(1:27,11)) mean(S2(1:27,11)) mean(S3(1:27,11))]; 
stdDSS = [std(S1(1:27,11)) std(S2(1:27,11)) std(S3(1:27,11))]; 

meanWSS = [mean(S1(1:27,11)./7) mean(S2(1:27,11)./7) mean(S3(1:27,11)./7)]; 
stdWSS = [std(S1(1:27,11)./7) std(S2(1:27,11)./7) std(S3(1:27,11)./7)]; 
