function plotLongitudinal_robotic_nonImpaired(array,names,axisDir)
...
for j = 1:length(names)
    ...
    ylabel(names{j}) 
    print(['Plots/LongitudinalPlots/robotic/210409_Indiv_' names{j} '_nonImp'],'-dpng')
...
%     end
%     ylabel(names{j}) 
%     print(['Plots/LongitudinalPlots/210409_Sum_NonImp' names{j}],'-dpng')
