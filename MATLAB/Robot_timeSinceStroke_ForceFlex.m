...
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/LongitudinalPlots/robotic/210817_ForceFlex_timeSinceStroke','-dpng')
...
xlabel('Time since stroke (days)') 
ylabel('Delta Force Flex (N)') 
%set(gca,'Ydir','reverse')
% xlim([-1.5 1.5])
% ylim([-1.5 3.5])
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_changeForceFlex_timeSinceStroke','-dpng')

figure; 
scatter(PM1(1:30,3), PM1(1:30,2), 'filled')
xlabel('Time since stroke (days)') 
ylabel('Force Flex @ T1 (deg)') 
%set(gca,'Ydir','reverse')
% xlim([-1.5 1.5])
% ylim([-1.5 3.5])
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_ForceFlexT1_timeSinceStroke','-dpng')
