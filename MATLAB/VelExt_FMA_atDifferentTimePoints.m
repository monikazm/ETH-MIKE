%% Compare Max Velocity Extension and FMA at different time points 
% created: 11.08.2021
...
ylabel('Max Vel Ext @ inclusion') 
title('Vel Ext vs FMA @ T1') 
print('Plots/ScatterPlots/210811_VelExt_FMA_inclusion','-dpng')
...
ylabel('Max Vel Ext @ discharge') 
title('Vel Ext vs FMA @ T3') 
print('Plots/ScatterPlots/210811_VelExt_FMA_discharge','-dpng')
...
ylabel('Delta by SRD Vel Ext') 
title('Delta Vel Ext by SRD vs delta FMA by MDC') 
print('Plots/ScatterPlots/210811_VelExt_FMA_changebySRD','-dpng')
