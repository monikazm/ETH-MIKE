...
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/LongitudinalPlots/robotic/210817_VelExt_timeSinceStroke','-dpng')
...
xlabel('Time since stroke (days)') 
ylabel('Delta Max Vel Ext (deg/s)') 
%set(gca,'Ydir','reverse')
% xlim([-1.5 1.5])
% ylim([-1.5 3.5])
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_changeVelExt_timeSinceStroke','-dpng')

figure; 
scatter(PM1(1:30,3), PM1(1:30,2), 'filled')
xlabel('Time since stroke (days)') 
ylabel('Max Vel Ext @ T1 (deg/s)') 
%set(gca,'Ydir','reverse')
% xlim([-1.5 1.5])
% ylim([-1.5 3.5])
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_VelExtT1_timeSinceStroke','-dpng')
