...
filename1 = 'data/20210504_DataImpaired.csv'; 
filename2 = 'data/20210504_DataNonImpaired.csv'; 
...
Both(:,5) = Both(:,3)>10.63; 
filename = 'PMimpaired_source.xlsx';
...
print('Plots/BaselineComparison/robotic/210504_PM_Indiv','-dpng')
...
xticklabels({'Affected' , 'Less affected'}); 
ylabel('Position Matching Absolute Error (deg)') 
print('Plots/BaselineComparison/robotic/210504_PM_withMean','-dpng')
