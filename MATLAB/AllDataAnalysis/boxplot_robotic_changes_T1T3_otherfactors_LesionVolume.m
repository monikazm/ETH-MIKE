%% why some subjects change and others don't - lesion volume as factor %%
% change / no change (two main groups) 
% created: 21.12.2021
...
B = readtable('data/LesionVolume.csv');
B2 = table2array(B); 
% 47 - kUDT
% 41 - FM M UL
% 48 - BB imp 
...
xlabel('Groups') 
ylabel('Lesion Volume @ T1') 
print('plots/BoxPlots/211221_ChangeGroups_LesionVolume','-dpng')

% statistical difference  
p_lv = kruskalwallis([change.S1(:,13); nochange.S1(:,13)],g); 
