...
for i=1:length(A)
    if A(i,2) == 0 
        ...
        ampl.T1.abs(n,5) = A(i,10); % Force T1
        ampl.T1.abs(n,6) = A(i,11); % Force T3
        ampl.T1.abs(n,7) = A(i,11)-A(i,10); % Force Delta
        n = n+1; 
    elseif A(i,2) < 0.5*A(i,4) 
        ...
        ampl.T1.imp(m,5) = A(i,10); % Force T1
        ampl.T1.imp(m,6) = A(i,11); % Force T3
        ampl.T1.imp(m,7) = A(i,11)-A(i,10); % Force Delta
        m = m+1; 
    elseif A(i,2) >= 0.5*A(i,4)
        ...
        ampl.T1.norm(k,5) = A(i,10); % Force T1
        ampl.T1.norm(k,6) = A(i,11); % Force T3
        ampl.T1.norm(k,7) = A(i,11)-A(i,10); % Force Delta
        k = k+1; 
    end
end
...
for i=1:length(A)
    if A(i,6) == 35
        ...
        lat.T1.abs(n,5) = A(i,10); % Force T1
        lat.T1.abs(n,6) = A(i,11); % Forc T3
        lat.T1.abs(n,7) = A(i,11)-A(i,10); % Forc Delta
        n = n+1; 
    elseif A(i,6)-A(i,8) > 1.1
        ...
        lat.T1.imp(m,5) = A(i,10); % Forc T1
        lat.T1.imp(m,6) = A(i,11); % Forc T3
        lat.T1.imp(m,7) = A(i,11)-A(i,10); % Forc Delta
        m = m+1; 
    elseif A(i,6)-A(i,8) <= 1.1
        ...
        lat.T1.norm(k,5) = A(i,10); % Forc T1
        lat.T1.norm(k,6) = A(i,11); % Forc T3
        lat.T1.norm(k,7) = A(i,11)-A(i,10); % Forc Delta
        k = k+1; 
    end
end
...
xlabel('MEP amplitude @ T1') 
ylabel('Delta Max Force Flexion (N)') 
print('plots/BoxPlots/211115_MEPampT1_Force_Delta','-dpng')
