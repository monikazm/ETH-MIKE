...
print('plots/BoxPlots/211126_MotorChangeGroups_PM','-dpng')
...
print('plots/BoxPlots/211126_MotorChangeGroups_Force','-dpng')
...
print('plots/BoxPlots/211126_MotorChangeGroups_Vel','-dpng')
...
g2 = repmat({'No change (N=25)'},length(nochangeS.S1(:,1)),1);
g = [g1;g2]; 
...
xlabel('Groups') 
ylabel('Position Matching Absolute Error @ T1') 
print('plots/BoxPlots/211126_SensoryChangeGroups_PM','-dpng')
...
xlabel('Groups') 
ylabel('Maximum Force Flexion @ T1') 
print('plots/BoxPlots/211126_SensoryChangeGroups_F','-dpng')
...
xlabel('Groups') 
ylabel('Maximum Velocity Extension @ T1') 
print('plots/BoxPlots/211126_SensoryChangeGroups_V','-dpng')
