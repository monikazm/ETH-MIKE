...
xlabel('SSEP latampitude @ T1') 
ylabel('Delta Position Matching Absolute Error (deg)') 
print('plots/BoxPlots/211115_SSEPamplat_PM_Delta','-dpng')
...
xlabel('SSEP latampitude @ T1') 
ylabel('Delta Position Matching Absolute Error (deg)') 
print('plots/BoxPlots/211115_SSEPamplat_PM_Delta_v2','-dpng')

% is the difference significant between the groups? 
% Kruskal Wallis
p_PMDelta_SSEPT1 = kruskalwallis([latamp.T1.absimp(:,7); latamp.T1.norm(:,7)],[g1;g2]); 
...
% PM
g1 = repmat({'Severely impaired'},length(latamp.T1.absimp(:,7)),1);
g2 = repmat({'Not severely impaired'},length(latamp.T1.norm(:,7)),1);
g = [g1;g2]; 
figure; 
boxplot([latamp.T1.absimp(:,7); latamp.T1.norm(:,7)],g) 
b = findobj(gca,'tag','Median');
...
xlabel('SSEP latency & amplitude @ T1') 
ylabel('Delta Position Matching Absolute Error (deg)') 
print('plots/BoxPlots/211115_SSEPamplat_PM_Delta_v3','-dpng')
...
print('plots/BoxPlots/211115_SSEPamplat_PM_T1_v2','-dpng')

% is the difference significant between the groups? 
% Kruskal Wallis
p_PMT1_SSEPT1 = kruskalwallis([latamp.T1.absimp(:,5); latamp.T1.norm(:,5)],[g1;g2]); 
