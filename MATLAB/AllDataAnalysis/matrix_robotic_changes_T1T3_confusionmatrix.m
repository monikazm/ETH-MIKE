...
change.s_m = 8; % change sensory & motor improve
change.m_sg = 12; %change motor, sensory good
change.m_si = 5; %change motor, sensory impaired 
nochange.sm_g = 3; %no change both because both good
nochange.sm_i = 15; %no change both but both impaired
change.s_mg = 1; % no change sensory, motor good at T1
change.s_mi = 1; %no change motor, sensory good at T1
nochange.m_sg = 0; 
nochange.s_mg = 0; 

%C = [kUDTimp_PMimp kUDTnonimp_PMimp; kUDTimp_PMnonimp kUDTnonimp_PMnonimp]; 
C = [change.s_m change.m_si change.m_sg; change.s_mi nochange.sm_i nochange.s_mg; change.s_mg nochange.m_sg nochange.sm_g]; 
label = {'Change';'No change: imp@T1'; 'No change: good@T1'}; 
