...
%% plot SSEP latampitude groups vs Force change
...
print('plots/BoxPlots/211206_MEPamplatT1_Force_Delta_v4','-dpng')
...
%% plot SSEP latampitude groups vs Force at T1
...
xlabel('MEP latency & amplitude @ T1') 
ylabel('Max Force Flexion (N) @ T1') 
print('plots/BoxPlots/211206_MEPamplatT1_Force_T1','-dpng')
