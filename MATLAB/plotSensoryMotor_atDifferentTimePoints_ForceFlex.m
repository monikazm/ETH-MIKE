...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('PM vs Force Flex @ T1')
print('Plots/ScatterPlots/210810_ForceFlexvsPM_T1','-dpng')
...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('PM vs Force Flex @ T3')
print('Plots/ScatterPlots/210810_ForceFlexvsPM_T3','-dpng')
...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta PM vs Force Flex')
print('Plots/ScatterPlots/210810_ForceFlexvsPM_delta','-dpng')
...
ylabel('Delta by SRD Max Force Flexion (N)') 
% xlim([-1.2 0.8])
ylim([-2 3.5])
title('Delta by SRD PM vs Force Flex')
print('Plots/ScatterPlots/210810_ForceFlexvsPM_deltabySRD','-dpng')
...
% xlim([-1.2 0.8])
ylim([-2 3.5])
title('Delta by SRD Force Flex vs PM @ T1')
print('Plots/ScatterPlots/210817_ForceFlex_deltabySRD_PMT1','-dpng')
