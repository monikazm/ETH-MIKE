...
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/LongitudinalPlots/robotic/210817_MAPR_timeSinceStroke','-dpng')
...
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_changeMAPR_timeSinceStroke','-dpng')

figure; 
scatter(PM1(1:30,3), PM1(1:30,2), 'filled')
xlabel('Time since stroke (days)') 
ylabel('Smoothness MAPR @ T1') 
%set(gca,'Ydir','reverse')
% xlim([-1.5 1.5])
% ylim([-1.5 3.5])
% yline(0,'k-.')
% xline(0,'k-.')
print('Plots/ScatterPlots/210823_MAPRT1_timeSinceStroke','-dpng')
