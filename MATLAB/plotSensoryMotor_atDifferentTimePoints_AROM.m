...
%ylim([-2 4])
title('PM vs AROM @ T1')
print('Plots/ScatterPlots/210810_AROMvsPM_T1','-dpng')
...
%ylim([-2 4])
title('PM vs AROM @ T3')
print('Plots/ScatterPlots/210810_AROMvsPM_T3','-dpng')
...
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta PM vs AROM')
print('Plots/ScatterPlots/210810_AROMvsPM_delta','-dpng')
...
ylabel('Delta by SRD Active Range of Motion (deg)') 
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta by SRD PM vs AROM')
print('Plots/ScatterPlots/210810_AROMvsPM_deltabySRD','-dpng')

% change by SRD
figure; 
scatter(Sesh1(:,3),change_bySRD(:,3), 'filled','k'); % x-sensory, y-motor
hold on
labelpoints(Sesh1(:,3),change_bySRD(:,3), txt3);
%set(gca,'XDir','reverse')
ylabel('Delta by SRD Position Matching Error (deg)') 
xlabel('Active Range of Motion (deg) @ T1') 
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta by SRD PM vs AROM @ T1')
print('Plots/ScatterPlots/210813_AROM_T1vsPM_deltabySRD','-dpng')
...
ylabel('Delta by SRD Active Range of Motion (deg) @ T1') 
% xlim([-1.2 0.8])
%ylim([-2 4])
title('Delta by SRD AROM vs PM @ T1')
print('Plots/ScatterPlots/210813_AROM_deltavsPM_T1','-dpng')
...
[RHO5,PVAL5] = corr(Sesh1(:,3),change_bySRD(:,3),'Type','Spearman');
[RHO6,PVAL6] = corr(Sesh1(:,4),change_bySRD(:,2),'Type','Spearman');
