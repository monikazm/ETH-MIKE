...
% N = 27 
Sesh1(1,:) = []; %remove the outlier 
Sesh3(1,:) = []; %remove the outlier 

Sesh1(26,:) = []; %remove the outlier 
...
for i = 1:length(Sesh1)
    plot([Sesh1(i,4) Sesh3(i,4)],[Sesh1(i,3) Sesh3(i,3)], 'o-k'); % x-sensory, y-motor
    hold on 
end
...
%ylim([-2 4])
title('PM vs AROM')
print('Plots/ScatterPlots/210713_AROMvsPM_atTwoTimePoints_change','-dpng')
